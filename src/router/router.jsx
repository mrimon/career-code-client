...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://career-code-server-five.vercel.app/jobs/${params.id}`)
            },
            {
                path: '/jobApply/:id',
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://career-code-server-five.vercel.app/applications/job/${params.job_id}`)
